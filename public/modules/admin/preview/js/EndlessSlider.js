define('EndlessSlider', ['jquery', 'Swiper'], function ($, Swiper) {

	var EndlessSlider = function(config){
		this.swiper;
		this.slideTmpl = '<div class="swiper-slide"></div>';
		this.maxLength = 3;
	...
	EndlessSlider.prototype = {
		...
		prependSlide : function(){
			...
			this.swiper.swipeTo(this.swiper.activeIndex + 1, 0);
